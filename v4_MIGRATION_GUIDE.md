...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:american-express:4.19.0'
  implementation 'com.braintreepayments.api:card:4.19.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:local-payment:4.19.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:samsung-pay:4.19.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:union-pay:4.19.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:venmo:4.19.0'
}
```
