...
object PostalAddressParser {
    ...
    fun fromJson(accountAddress: JSONObject?): PostalAddress =
        ...
        accountAddress?.let {
            ...
            countryCodeAlpha2 = countryCodeAlpha2 ?: Json.optString(
                accountAddress,
                COUNTRY_CODE_KEY,
                null
            )

            streetAddress = streetAddress ?: Json.optString(
                accountAddress,
                VENMO_GQL_ADDRESS1_KEY,
                null
            )
            extendedAddress = extendedAddress ?: Json.optString(
                accountAddress,
            ...
            PostalAddress().apply {
                ...
                recipientName = recipientName ?: Json.optString(
                    accountAddress,
