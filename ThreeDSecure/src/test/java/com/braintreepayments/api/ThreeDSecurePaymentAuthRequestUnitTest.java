...
public class ThreeDSecurePaymentAuthRequestUnitTest {

    @Test
    public void fromJson_parsesCorrectly_v1() throws JSONException {
        ThreeDSecurePaymentAuthRequest authResponse = ThreeDSecurePaymentAuthRequest.fromJson(
    ...
    public void isParcelable() throws JSONException {
        ...
        ThreeDSecurePaymentAuthRequest parceled = ThreeDSecurePaymentAuthRequest.CREATOR.createFromParcel(parcel);
