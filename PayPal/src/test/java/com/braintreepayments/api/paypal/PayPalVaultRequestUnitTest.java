...
public class PayPalVaultRequestUnitTest {
    ...
    public void setsValuesCorrectly() {
        ...
        request.setUserAction(PayPalPaymentUserAction.USER_ACTION_SETUP_NOW);
        ...
        assertEquals(PayPalPaymentUserAction.USER_ACTION_SETUP_NOW, request.getUserAction());
    ...
    public void parcelsCorrectly() {
        ...
        assertEquals(PayPalPaymentUserAction.USER_ACTION_SETUP_NOW, result.getUserAction());
