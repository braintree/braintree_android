...
public class ThreeDSecureRequest implements Parcelable {
     ...
     */
    public void shippingMethod(@ThreeDSecureShippingMethod int shippingMethod) {
     ...
     */
    public void billingAddress(ThreeDSecurePostalAddress billingAddress) {
     ...
     */
    public void versionRequested(@ThreeDSecureVersion String versionRequested) {
     ...
     */
    public void accountType(@ThreeDSecureAccountType String accountType) {
     ...
     */
    public void additionalInformation(ThreeDSecureAdditionalInformation additionalInformation) {
     ...
     */
    public void challengeRequested(boolean challengeRequested) {
        mChallengeRequested = challengeRequested;
    }

    public void dataOnlyRequested(boolean dataOnlyRequested) {
     ...
     */
    public void exemptionRequested(boolean exemptionRequested) {
     ...
     */
    public void v2UiCustomization(ThreeDSecureV2UiCustomization v2UiCustomization) {
     ...
     */
    public void v1UiCustomization(ThreeDSecureV1UiCustomization v1UiCustomization) {
