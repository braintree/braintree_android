...
public class PayPalDataCollectorUnitTest {
    ...
    @Test
    public void getClientMetadataId_configuresMagnesWithClientMetadataId() throws InvalidInputException {
        when(payPalInstallationIdentifier.getInstallationGUID(context)).thenReturn("sample-application-guid");

        when(magnesSDK.collectAndSubmit(any(Context.class), eq("client-metadata-id"), ArgumentMatchers.<HashMap<String, String>>isNull()))
                .thenReturn(mock(MagnesResult.class));

        PayPalDataCollector sut = new PayPalDataCollector(magnesSDK, payPalInstallationIdentifier);
        sut.getClientMetadataId(context, "client-metadata-id");
    ...
    public void getClientMetadataId_returnsEmptyStringWhenMagnesInputInvalid() throws InvalidInputException {
        ...
        when(magnesSDK.collectAndSubmit(any(Context.class), anyString(), ArgumentMatchers.<HashMap<String, String>>isNull()))
