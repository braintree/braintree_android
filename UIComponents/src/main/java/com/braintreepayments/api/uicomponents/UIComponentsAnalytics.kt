...
internal object UIComponentsAnalytics {

    const val PAYPAL_BUTTON_PRESENTED = "ui-components:paypal-button:presented"
    const val PAYPAL_BUTTON_SELECTED = "ui-components:paypal-button:selected"
