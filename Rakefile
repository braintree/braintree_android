...
task :publish_snapshot => :tests do
  ...
  replace_string(braintree_drop_in_build_file, "compile project(':BraintreeApi')", "compile 'com.braintreepayments.api:braintree-api:#{get_current_version}@aar'")
  ...
  replace_string(braintree_drop_in_build_file, "compile 'com.braintreepayments.api:braintree-api:#{get_current_version}@aar'", "compile project(':BraintreeApi')")
end
...
task :release => :tests do
  ...
  replace_string(braintree_drop_in_build_file, "compile project(':BraintreeApi')", "compile 'com.braintreepayments.api:braintree-api:#{version}@aar'")
  sh "./gradlew clean :Drop-In:uploadArchives"
  ...
  replace_string(braintree_drop_in_build_file, "compile 'com.braintreepayments.api:braintree-api:#{version}@aar'", "compile project(':BraintreeApi')")
