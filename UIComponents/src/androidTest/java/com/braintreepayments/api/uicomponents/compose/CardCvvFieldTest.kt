...
class CardCvvFieldTest {
    ...
    fun typingDigits_updatesFieldText() {
        ...
        composeTestRule.onNodeWithContentDescription(str(R.string.cvv_hint_accessibility))
    ...
    @Test
    fun errorText_isDisplayed_whenErrorIsPresent() {
        setCvvField(errorText = "CVV is invalid")

        composeTestRule.onNodeWithText("CVV is invalid").assertIsDisplayed()
    }

    @Test
    fun errorText_isNotDisplayed_whenErrorIsNotPresent() {
        setCvvField(errorText = null)

        composeTestRule.onNodeWithText("CVV is invalid").assertDoesNotExist()
    }
