...
public class PayPalApiLineItem implements Parcelable {

    @Retention(RetentionPolicy.SOURCE)
    @StringDef({PayPalApiLineItem.KIND_CREDIT, PayPalApiLineItem.KIND_DEBIT})
    ...
    */
     ...
     */
    public PayPalApiLineItem(@NonNull @PayPalLineItemKind String kind,
                             @NonNull String name,
    ...
    private PayPalApiLineItem(Parcel in) {
    ...
    public static final Creator<PayPalApiLineItem> CREATOR = new Creator<PayPalApiLineItem>() {
        public PayPalApiLineItem createFromParcel(Parcel source) {
            return new PayPalApiLineItem(source);
        }

        public PayPalApiLineItem[] newArray(int size) {
            return new PayPalApiLineItem[size];
        }
    };
}
