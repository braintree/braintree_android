...
public enum CardType {
    ...
    VISA("^4\\d*",
            R.drawable.ic_visa_small,
            16, 16,
            3),
    MASTERCARD("^5[1-5]\\d*",
            R.drawable.ic_mastercard_small,
            16, 16,
            3),
    DISCOVER("^(6011|65|64[4-9]|622)\\d*",
            R.drawable.ic_discover_small,
            16, 16,
            3),
    AMEX("^3[47]\\d*",
            R.drawable.ic_amex_small,
            15, 15,
            4),
    DINERS_CLUB("^(36|38|30[0-5])\\d*",
            R.drawable.ic_diners_small,
            14, 14,
            3),
    JCB("^35\\d*",
            R.drawable.ic_jcb_small,
            16, 16,
            3),
    MAESTRO("^(5018|5020|5038|6304|6759|676[1-3])\\d*",
            R.drawable.ic_maestro_small,
            12, 19,
            3),
    UNION_PAY("^62\\d*",
            R.drawable.ic_card_number_highlighted,
            16, 19,
            3),
    UNKNOWN("",
            R.drawable.ic_card_number_highlighted,
