...
public class ThreeDSecureAdditionalInformation implements Parcelable {
    ...
    /**
     * Optional. The 2-digit number indicating whether the cardholder is reordering previously
    ...
    /**
     * Optional. The 2-digit number indicating whether the cardholder is placing an order with a
    ...
    /**
     * Optional. The 8-digit number (format: YYYYMMDD) indicating expected date that a pre-ordered
    ...
    /**
     * Optional. The 8-digit number (format: YYYYMMDD) indicating the date the cardholder opened the
     * account.
     */
    ...
    /**
     * Optional. The 2-digit value representing the length of time since the last change to the
     * cardholder account. This includes shipping address, new payment account or new user added.
     * <p>
    ...
    /**
     * Optional. The 8-digit number (format: YYYYMMDD) indicating the date the cardholder's account
     * was last changed. This includes changes to the billing or shipping address, new payment
     * accounts or new users added.
     */
    ...
    /**
     * Optional. The 2-digit value representing the length of time since the cardholder changed or
    ...
    /**
     * Optional. The 8-digit number (format: YYYYMMDD) indicating the date the cardholder last
     * changed or reset password on account.
     */
    ...
    /**
     * Optional. The 2-digit value indicating when the shipping address used for transaction was
     * first used.
     * <p>
    ...
    /**
     * Optional. The 8-digit number (format: YYYYMMDD) indicating the date when the shipping address
     * used for this transaction was first used.
     */
    ...
    /**
     * Optional. Number of transactions (successful or abandoned) for this cardholder account within
     * the last 24 hours.
     */
    ...
    /**
     * Optional. The 2-digit value indicating whether the merchant experienced suspicious activity
     * (including previous fraud) on the account.
     * <p>
    ...
    /**
     * Optional. The 2-digit value indicating if the cardholder name on the account is identical to
     * the shipping name used for the transaction.
     * <p>
    ...
    /**
     * Optional. The 2-digit value indicating the length of time that the payment account was
     * enrolled in the merchant account.
     * <p>
    ...
    /**
     * Optional. The 8-digit number (format: YYYYMMDD) indicating the date the payment account was
     * added to the cardholder account.
     */
    ...
    /**
     * Optional. The 1-character value (Y/N) indicating whether cardholder billing and shipping
     * addresses match.
     */
    ...
    /**
     * Optional.  An integer value greater than 1 indicating the maximum number of permitted
    ...
    /**
     * Optional. The 14-digit number (format: YYYYMMDDHHMMSS) indicating the date in UTC of original
     * purchase.
     */
    ...
    /**
     * Optional. The 8-digit number (format: YYYYMMDD) indicating the date after which no further
     * recurring authorizations should be performed..
     */
    ...
    /**
     * Optional. Integer value indicating the minimum number of days between recurring
     * authorizations. A frequency of monthly is indicated by the value 28. Multiple of 28 days will
     * be used to indicate months (ex. 6 months = 168).
     */
    ...
    /**
     * Optional. The 2-digit number of minutes (minimum 05) to set the maximum amount of time for
     * all 3DS 2.0 messages to be communicated between all components.
     */
    ...
    /**
     * Optional. The work phone number used for verification. Only numbers; remove dashes,
     * parenthesis and other characters.
     */
    ...
    public static final Parcelable.Creator<ThreeDSecureAdditionalInformation> CREATOR =
            new Parcelable.Creator<ThreeDSecureAdditionalInformation>() {
                @Override
    ...
    public JSONObject toJson() {
        ...
        try {
            if (shippingAddress != null) {
                ...
                additionalInformation.putOpt("shipping_line2",
                ...
                additionalInformation.putOpt("shipping_postal_code",
                        shippingAddress.getPostalCode());
                additionalInformation.putOpt("shipping_country_code",
            ...
            additionalInformation.putOpt("shipping_address_usage_indicator",
