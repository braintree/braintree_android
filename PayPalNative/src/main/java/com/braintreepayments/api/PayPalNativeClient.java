...
public class PayPalNativeClient {
    ...
    /**
     * Create a new instance of {@link PayPalNativeClient} from within an Activity using a {@link BraintreeClient}.
     *
     * @param activity        a {@link FragmentActivity}
     * @param braintreeClient a {@link BraintreeClient}
     */
    public PayPalNativeClient(@NonNull FragmentActivity activity, @NonNull BraintreeClient braintreeClient) {
        this(activity, activity.getLifecycle(), braintreeClient, new PayPalInternalClient(braintreeClient));
    }

    /**
     * Create a new instance of {@link PayPalNativeClient} from within a Fragment using a {@link BraintreeClient}.
     *
     * @param fragment        a {@link Fragment
     * @param braintreeClient a {@link BraintreeClient}
     */
    public PayPalNativeClient(@NonNull Fragment fragment, @NonNull BraintreeClient braintreeClient) {
        this(fragment.getActivity(), fragment.getLifecycle(), braintreeClient, new PayPalInternalClient(braintreeClient));
    }

    /**
     * Create a new instance of {@link PayPalNativeClient} using a {@link BraintreeClient}.
     * <p>
     * Deprecated. Use {@link PayPalNativeClient (Fragment, BraintreeClient)} or
     * {@link PayPalNativeClient (FragmentActivity, BraintreeClient)}.
     *
     * @param braintreeClient a {@link BraintreeClient}
     */
    @Deprecated
    public PayPalNativeClient(@NonNull BraintreeClient braintreeClient) {
        this(null, null, braintreeClient, new PayPalInternalClient(braintreeClient));
    }

    @VisibleForTesting
    PayPalNativeClient(FragmentActivity activity, Lifecycle lifecycle, BraintreeClient braintreeClient, PayPalInternalClient internalPayPalClient) {
     ...
     * This method must be invoked on a {@link PayPalNativeClient (Fragment, BraintreeClient)} or
     * {@link PayPalNativeClient (FragmentActivity, BraintreeClient)} in order to receive results.
     *
     ...
     * Tokenize a PayPal account for vault or checkout.
     * <p>
     * Deprecated. Use {@link PayPalNativeClient#tokenizePayPalAccount(FragmentActivity, PayPalRequest)}
     *
     * @param activity      Android FragmentActivity
     * @param payPalRequest a {@link PayPalRequest} used to customize the request.
...
//        PayPalCheckout.startCheckout(createOrder);
     ...
     * @param callback              {@link PayPalFlowStartedCallback}
     * @deprecated Use {@link PayPalNativeClient#tokenizePayPalAccount(FragmentActivity, PayPalRequest, PayPalFlowStartedCallback)} instead.
