...
public abstract class Request<T extends Request<T>> implements Parcelable {
    ...
    /**
     * Defines the host to be used in the cancelation url for browser switch (the package name will be used as the scheme)
     */
    ...
    /**
     * Supplies the implementing class type. Useful only for using the Abstract
     * Builder pattern. Not to be confused with youAreNotGonnaBelieveThis() or
     * nowHearThis()
     *
     * @return
     */
     ...
     * @return
     */
    public abstract String getBrowserSwitchUrl(Context context, OtcConfiguration config) throws CertificateException, UnsupportedEncodingException, NoSuchPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, JSONException, BadPaddingException, InvalidEncryptionDataException, InvalidKeyException, InvalidKeySpecException;
