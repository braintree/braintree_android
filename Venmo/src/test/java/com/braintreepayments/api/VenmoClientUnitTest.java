...
public class VenmoClientUnitTest {
    ...
    public void tokenize_withPaymentContextId_requestFromVenmoApi() {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo("payment-context-id", "payment-context-id",
                        "venmo-username", null);
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
    ...
    public void tokenize_withPaymentAuthResultError_whenUserCanceledError_returnsCancelAndSendsAnalytics() {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo(null, null, null, new UserCanceledException("User canceled Venmo."));
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
    ...
    public void tokenize_withPaymentAuthResultError_returnsErrorAndSendsAnalytics() {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo(null, null, null, error);
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
    ...
    public void tokenize_onGraphQLPostSuccess_returnsNonceToListener_andSendsAnalytics()
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo("payment-context-id", "venmo-nonce", "venmo-username",
                        null);
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
    ...
    public void tokenize_withPaymentContext_performsVaultRequestIfRequestPersisted() {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo("payment-context-id", "some-nonce", "venmo-username",
                        null);
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
    ...
    public void tokenize_sendsAnalyticsEventOnCancel() {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo("payment-context-id", null, null,
    ...
    public void tokenize_forwardsExceptionToCallbackOnCancel() {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo("payment-context-id", null, null, error);
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
    ...
    public void tokenize_performsVaultRequestIfRequestPersisted() throws JSONException {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo("payment-context-id", "sample-nonce", "venmo-username",
                        null);
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
    ...
    public void tokenize_withSuccessfulVaultCall_forwardsResultToActivityResultListener_andSendsAnalytics() {
        ...
        VenmoPaymentAuthResultInfo venmoPaymentAuthResultInfo =
                new VenmoPaymentAuthResultInfo(null, "sample-nonce", "venmo-username", null);
        sut.tokenize(venmoPaymentAuthResultInfo, venmoTokenizeCallback);
