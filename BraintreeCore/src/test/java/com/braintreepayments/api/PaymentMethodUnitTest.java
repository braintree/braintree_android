...
public class PaymentMethodUnitTest {
    ...
    public void getPaymentMethodNonces_returnsAnEmptyListIfEmpty() {
        ...
        ArgumentCaptor<List<UntypedPaymentMethodNonce>> captor = ArgumentCaptor.forClass((Class) List.class);
    ...
    public void getPaymentMethodNonces_throwsAnError() {
        ...
        verify(callback).onResult((List<UntypedPaymentMethodNonce>) isNull(), captor.capture());
    ...
    public void getPaymentMethodNonces_fetchesPaymentMethods() {
        ...
        List<UntypedPaymentMethodNonce> paymentMethodNonces = captor.getValue();
    ...
    public void deletePaymentMethodNonce_withTokenizationKey_throwsAnError() throws InvalidArgumentException {
        ...
        ArgumentCaptor<Exception> captor = ArgumentCaptor.forClass(Exception.class);
        verify(callback).onResult((UntypedPaymentMethodNonce) isNull(), captor.capture());
    ...
    public void deletePaymentMethodNonce_throwsAnError()
        ...
        UntypedPaymentMethodNonce paymentMethodNonce = paymentMethodDeleteException.getPaymentMethodNonce();
