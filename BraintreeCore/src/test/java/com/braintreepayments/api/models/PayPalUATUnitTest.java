...
public class PayPalUATUnitTest {
    ...
    public void fromString_setsAllProperties() throws InvalidArgumentException {
        PayPalUAT payPalUAT = (PayPalUAT) Authorization.fromString(stringFromFixture("base_64_paypal_uat.txt"));
        ...
        assertEquals(stringFromFixture("base_64_paypal_uat.txt"), payPalUAT.getBearer());
