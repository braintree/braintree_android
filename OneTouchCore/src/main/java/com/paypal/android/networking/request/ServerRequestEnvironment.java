...
/**
 * Interface for requests that need to talk to the configuration, or perform
 * callbacks.
 * 
 */
public interface ServerRequestEnvironment {
    /**
     * Sends the ServerRequest to a handler to be processed on the Looper
     * thread.
     *
     * @param request
     */
    ...
    /**
	 * Return the url configured for the input API. If the api is unspecified,
	 * return null.
	 * 
	 * @param api
	 * @return
