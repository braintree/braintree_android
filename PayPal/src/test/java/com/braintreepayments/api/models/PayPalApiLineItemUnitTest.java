...
public class PayPalApiLineItemUnitTest {

    @Test
    public void parcelsCorrectly() {
        PayPalApiLineItem item = new PayPalApiLineItem(PayPalApiLineItem.KIND_DEBIT, "An Item", "1", "2");
        ...
        PayPalApiLineItem result = PayPalApiLineItem.CREATOR.createFromParcel(parcel);
