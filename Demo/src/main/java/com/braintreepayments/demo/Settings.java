...
public class Settings {
    ...
    private static final String SANDBOX_TOKENIZATION_KEY = "sandbox_rzqzswv4_cg5s96bvw9gzmwmc";

    private static final String SANDBOX_INDIA_BASE_SERVER_URL = "https://braintree-india-2fa-merchant.herokuapp.com/";

    static final String LOCAL_PAYMENTS_TOKENIZATION_KEY = "sandbox_8hpbq6nh_ks3tvzmhdjryvknn";
