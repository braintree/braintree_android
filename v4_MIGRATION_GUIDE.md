...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:american-express:4.18.0'
  implementation 'com.braintreepayments.api:card:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:data-collector:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:local-payment:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:google-pay:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:paypal:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:samsung-pay:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:union-pay:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:venmo:4.18.0'
}
```
...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:three-d-secure:4.18.0'
}
```
