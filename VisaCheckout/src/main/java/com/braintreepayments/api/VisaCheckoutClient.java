            ...
            public void onResult(JSONObject tokenizationResponse, Exception exception) {
                if (tokenizationResponse != null) {
                    try {
                        ...
                        braintreeClient.sendAnalyticsEvent("visacheckout.tokenize.succeeded", new AnalyticsEventPayload.Builder().build());
                    } catch (JSONException e) {
                        callback.onResult(null, e);
                    }
                } else {
                    callback.onResult(null, exception);
                    braintreeClient.sendAnalyticsEvent("visacheckout.tokenize.failed", new AnalyticsEventPayload.Builder().build());
                }
            }
        });
    }
