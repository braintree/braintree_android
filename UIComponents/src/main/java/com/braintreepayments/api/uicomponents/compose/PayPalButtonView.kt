...
fun PreviewButtons() {
    ...
    Column(modifier = Modifier.padding(16.dp).width(480.dp), horizontalAlignment = Alignment.CenterHorizontally) {
        PayPalButtonView(style = PayPalButtonColor.Blue) {
            Toast.makeText(context, "Clicked", Toast.LENGTH_SHORT).show()
        }
        PayPalButtonView(style = PayPalButtonColor.Black) {
            Toast.makeText(context, "Clicked", Toast.LENGTH_SHORT).show()
        }
        PayPalButtonView(style = PayPalButtonColor.White) {
            Toast.makeText(context, "Clicked", Toast.LENGTH_SHORT).show()
        }
        PayPalButtonView(style = PayPalButtonColor.Blue, enabled = false) {
            Toast.makeText(context, "Clicked", Toast.LENGTH_SHORT).show()
        }
        PayPalButtonView(style = PayPalButtonColor.Black, enabled = false) {
            Toast.makeText(context, "Clicked", Toast.LENGTH_SHORT).show()
        }
        PayPalButtonView(style = PayPalButtonColor.White, enabled = false) {
            Toast.makeText(context, "Clicked", Toast.LENGTH_SHORT).show()
        }
    }
}
