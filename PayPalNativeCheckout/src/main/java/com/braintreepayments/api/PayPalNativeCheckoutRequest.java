...
public class PayPalNativeCheckoutRequest extends PayPalNativeRequest implements Parcelable {
    ...
    @StringDef({PayPalNativeCheckoutRequest.USER_ACTION_DEFAULT, PayPalNativeCheckoutRequest.USER_ACTION_COMMIT})
     ...
     *
     * @param intent {@link PayPalNativeCheckoutPaymentIntent}
     ...
     * {@link PayPalNativeCheckoutRequest#USER_ACTION_COMMIT} changes the button text to "Pay Now",
     ...
     *                   <ul>
     *                   <li>{@link PayPalNativeCheckoutRequest#USER_ACTION_COMMIT}</li>
     *                   <li>{@link PayPalNativeCheckoutRequest#USER_ACTION_DEFAULT}</li>
     *                   </ul>
    ...
    String createRequestBody(Configuration configuration, Authorization authorization, String successUrl, String cancelUrl) throws JSONException {
        ...
        if (!getLineItems().isEmpty()) {
            ...
            for (PayPalNativeCheckoutLineItem lineItem : getLineItems()) {
    ...
    PayPalNativeCheckoutRequest(Parcel in) {
        super(in);
